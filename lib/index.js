...
function validateSpecial(data, schema) {
	...
	debug('validateSpecial', data, schema, typeof schema);
 ...
 * @return {Object}       An error object, if the validation failed
 */
function validateConstant(data, schema) {
	debug('validateConstant', data, schema);
	...
	validateRoot: function(data, schema) {
		...
		if (Array.isArray(schemaData)) {
			...
			if (schemaData === JSOND_BOOLEAN) {
				...
				err = validateConstant(data, schemaData);
			}
		}
